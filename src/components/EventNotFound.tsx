    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-white dark:bg-gray-900 text-center px-4 animate-fadeIn">
      <div className="max-w-md">
        <div className="mx-auto mb-6">
          <svg
            className="w-24 h-24 text-indigo-500 dark:text-indigo-400 mx-auto"
            fill="none"
            stroke="currentColor"
            strokeWidth="1.5"
            viewBox="0 0 24 24"
        ...
        <Link
          href="/"
          className="inline-block bg-indigo-600 hover:bg-indigo-700 text-white font-medium py-2 px-4 rounded-md transition duration-200"
        >
          Go Back Home
        </Link>
      </div>
