...
function LatestEvent() {
  ...
  return (
    <section className="relative py-20 overflow-hidden bg-gradient-to-br from-blue-50 via-white to-blue-50 dark:from-gray-900 dark:via-blue-900 dark:to-gray-900">
      {navigating && <Loader />}
      {toast && (
        <Toast
          type={toast.type}
