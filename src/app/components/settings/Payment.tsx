...
const Payment = () => {
  ...
  useEffect(() => {
    // Simulated revenue history data
  ...
  return (
    <div className="max-w-5xl mx-auto p-6 bg-white shadow-lg rounded-lg dark:bg-gray-800 dark:text-gray-200">
            ...
            <div className="flex justify-between items-center mt-4">
              <button
                ...
                className={`text-sm px-3 py-1 rounded-lg ${
                  method.default ? 'bg-green-500 text-white' : 'bg-gray-200 text-gray-700'
                }`}
              >
      ...
      <button
        ...
        className="bg-green-500 text-white px-4 py-2 rounded-md shadow hover:bg-green-600 transition w-full mt-6"
      >
        Save All Settings
      </button>
