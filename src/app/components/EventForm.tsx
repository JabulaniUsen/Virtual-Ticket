...
const EventForm: React.FC<EventFormProps> = ({ open, onClose }) => {
  ...
  return (
    ...
    >
      <div className="bg-white dark:bg-gray-800 w-full max-w-lg p-6 rounded-lg shadow-xl overflow-hidden max-h-[80vh]">
        ...
        <form onSubmit={(e) => e.preventDefault()} className="space-y-4 overflow-y-auto max-h-[70vh] pb-6 px-2">
          ...
          <div className="flex justify-end gap-2 mt-6">
            <button
              type="button"
              onClick={onClose}
              className="px-4 py-2 bg-gray-300 rounded-md dark:bg-gray-600 dark:text-white hover:bg-gray-400 dark:hover:bg-gray-500 transition"
            >
              Cancel
            </button>
            <button
