...
export default function VirtualEventTickets({ 
  ...
  return (
    <>
      ...
      <div className="py-10 px-2 sm:px-6 bg-gradient-to-br from-blue-50 via-purple-50 to-white dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 min-h-[80vh]">
        <h2 className="text-3xl sm:text-4xl font-extrabold text-center mb-12 text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-purple-600 to-blue-600 tracking-tight flex items-center justify-center gap-3">
          <FaTicketAlt className="inline-block text-purple-500 text-3xl" />
        ...
        <div className="flex flex-wrap gap-8 justify-center">
          {event.ticketType.map((ticket, index) => {
            ...
            return (
              ...
              >
                {/* Ticket stub left */}
                <div className="absolute -left-4 top-1/2 -translate-y-1/2 w-8 h-16 bg-gradient-to-b from-blue-500 to-purple-500 rounded-l-3xl shadow-lg z-10 border-4 border-white dark:border-gray-900"></div>
                {/* Ticket stub right */}
                <div className="absolute -right-4 top-1/2 -translate-y-1/2 w-8 h-16 bg-gradient-to-b from-blue-500 to-purple-500 rounded-r-3xl shadow-lg z-10 border-4 border-white dark:border-gray-900"></div>
                {/* Perforation */}
        ...
        <div className="max-w-xl mx-auto mt-14">
          <div className="flex items-center gap-3 bg-gradient-to-r from-blue-100 to-purple-100 dark:from-gray-800 dark:to-gray-700 p-5 rounded-2xl border border-gray-200 dark:border-gray-600 shadow">
