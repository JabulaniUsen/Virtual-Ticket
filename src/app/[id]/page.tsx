...
const EventDetail = () => {
  ...
  return (
    <div
      className="event-page-container text-gray-900 dark:text-gray-100 bg-gray-300/40  dark:bg-gray-900">
      {loading && <Loader />}
                ...
                <div className="space-y-5">
                  ...
                  <div className="flex flex-col gap-3">
                    <div className="flex items-center space-x-3 text-blue-600 dark:text-blue-400">
                      ...
                      <p className="text-xl sm:text-lg font-medium">{events.venue}, {events.location}</p>
                    </div>
