          ...
          <div className="space-y-6">
            ...
            <form onSubmit={handleSignup} className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    name="password"
                    placeholder="••••••••"
                    className="w-full pl-10 pr-12 py-2.5  border rounded-xl font-light focus:outline-none focus:ring-2 focus:ring-blue-400 text-black placeholder-blue-100/50"
                    required
                  />
                  <button
                    type="button"
              ...
              <div className="flex items-center space-x-2">
                ...
                <label htmlFor="agreeTerms" className="text-sm text-gray-500 dark:text-gray-300">
                  ...
                  <button
                    ...
                    className="text-black dark:text-blue-300 underline hover:text-blue-300 dark:hover:text-blue-200"
                  >
              ...
              <button
                ...
                transition-all duration-300 bg-blue-600 hover:bg-blue-700
                ${
                  agreeTerms
