...
export default function CreateEventPage() {
    ...
    if (savedData) {
      try {
        setFormData(prev => ({
          ...prev,
          ...savedData,
          image: null, // Force re-upload of image for security
          gallery: []  // Force re-upload of gallery images
        }));
  ...
  const renderStepContent = () => {
    ...
    switch (step) {
      ...
      case 2:
        return <TicketSetup {...commonProps} onNext={handleNext} />;
      case 3:
        return <TicketDetails {...commonProps} onNext={handleNext} />;
      case 4:
        return <FinalDetails {...commonProps} />;
      default:
        return null;
    }
  };
